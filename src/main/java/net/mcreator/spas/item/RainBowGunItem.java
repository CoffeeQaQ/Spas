...
import net.mcreator.spas.entity.renderer.RainBowGunRenderer;
import net.mcreator.spas.SpasModElements;

import java.util.Random;

@SpasModElements.ModElement.Tag
public class RainBowGunItem extends SpasModElements.ModElement {
	@ObjectHolder("spas:rain_bow_gun")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletrain_bow_gun").setRegistryName("entitybulletrain_bow_gun");
	public RainBowGunItem(SpasModElements instance) {
		super(instance, 21);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RainBowGunRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SpasItemGroup.tab).maxDamage(100));
			setRegistryName("rain_bow_gun");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 100f, 100, 24);
	...
	public static ArrowCustomEntity shoot(LivingEntity entity, LivingEntity target) {
		...
		entityarrow.setKnockbackStrength(24);
		entityarrow.setIsCritical(false);
		entityarrow.setFire(100);
