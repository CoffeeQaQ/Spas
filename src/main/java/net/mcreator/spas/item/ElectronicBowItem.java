...
import net.mcreator.spas.entity.renderer.ElectronicBowRenderer;
import net.mcreator.spas.SpasModElements;

import java.util.Random;

@SpasModElements.ModElement.Tag
public class ElectronicBowItem extends SpasModElements.ModElement {
	@ObjectHolder("spas:electronic_bow")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletelectronic_bow").setRegistryName("entitybulletelectronic_bow");
	public ElectronicBowItem(SpasModElements instance) {
		super(instance, 24);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ElectronicBowRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SpasItemGroup.tab).maxDamage(1000));
			setRegistryName("electronic_bow");
		}
