...
public class LuckyStoneItem extends SpasModElements.ModElement {
	@ObjectHolder("spas:lucky_stone")
	public static final Item block = null;
	public LuckyStoneItem(SpasModElements instance) {
		super(instance, 28);
	}
