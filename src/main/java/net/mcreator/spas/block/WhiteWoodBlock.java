...
public class WhiteWoodBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:white_wood")
	public static final Block block = null;
	public WhiteWoodBlock(SpasModElements instance) {
		super(instance, 1);
	}
