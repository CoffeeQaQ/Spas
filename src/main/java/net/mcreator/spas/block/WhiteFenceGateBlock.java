...
public class WhiteFenceGateBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:white_fence_gate")
	public static final Block block = null;
	public WhiteFenceGateBlock(SpasModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("white_fence_gate");
		}
