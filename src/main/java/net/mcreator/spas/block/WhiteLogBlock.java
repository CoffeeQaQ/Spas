...
public class WhiteLogBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:white_log")
	public static final Block block = null;
	public WhiteLogBlock(SpasModElements instance) {
		super(instance, 2);
	}
