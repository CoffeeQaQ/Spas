...
public class WhiteStairsBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:white_stairs")
	public static final Block block = null;
	public WhiteStairsBlock(SpasModElements instance) {
		super(instance, 5);
	}
