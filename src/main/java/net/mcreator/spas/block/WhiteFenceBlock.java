...
public class WhiteFenceBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:white_fence")
	public static final Block block = null;
	public WhiteFenceBlock(SpasModElements instance) {
		super(instance, 12);
	}
