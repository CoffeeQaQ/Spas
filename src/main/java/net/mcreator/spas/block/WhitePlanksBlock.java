...
public class WhitePlanksBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:white_planks")
	public static final Block block = null;
	public WhitePlanksBlock(SpasModElements instance) {
		super(instance, 3);
	}
