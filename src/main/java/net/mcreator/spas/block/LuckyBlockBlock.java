...
import net.mcreator.spas.procedures.LuckyBlockDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class LuckyBlockBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:lucky_block")
	public static final Block block = null;
	public LuckyBlockBlock(SpasModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				LuckyBlockDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
