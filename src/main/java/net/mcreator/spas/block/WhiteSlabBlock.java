...
public class WhiteSlabBlock extends SpasModElements.ModElement {
	@ObjectHolder("spas:white_slab")
	public static final Block block = null;
	public WhiteSlabBlock(SpasModElements instance) {
		super(instance, 6);
	}
