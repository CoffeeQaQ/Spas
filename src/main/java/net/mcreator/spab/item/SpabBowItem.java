...
public class SpabBowItem extends Item {
	public SpabBowItem() {
		super(new Item.Properties().tab(SpabModTabs.TAB_SPAB).durability(100));
		setRegistryName("spab_bow");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					SpabBowEntity entityarrow = SpabBowEntity.shoot(world, entity, world.getRandom(), 1f, 5, 2);
