...
package net.mcreator.spab.world.inventory;
...
import net.mcreator.spab.init.SpabModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class SpabRecipestationGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SpabRecipestationGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SpabModMenus.SPAB_RECIPESTATION_GUI, id);
