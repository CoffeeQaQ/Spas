package net.mcreator.spab.world.features.treedecorators;
...
public class RedTrunkDecorator extends TrunkVineDecorator {
	public static final RedTrunkDecorator INSTANCE = new RedTrunkDecorator();
	public static com.mojang.serialization.Codec<RedTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("red_tree_trunk_decorator");
