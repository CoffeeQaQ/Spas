...
import net.mcreator.spab.client.particle.ParticleParticle;
...
public class SpabModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType PARTICLE = register(new SimpleParticleType(true).setRegistryName("particle"), ParticleParticle::provider);
